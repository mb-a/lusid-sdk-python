...
class PolicyUpdateRequest(Model):
    """Update policy request.

    :param meta: Meta data associated with the policy
    :type meta: ~shrine.models.PolicyUpdateRequestMeta
    ...
    _attribute_map = {
        'meta': {'key': 'meta', 'type': 'PolicyUpdateRequestMeta'},
    ...
    def __init__(self, grant, paths, when, meta=None, description=None, applications=None, for_property=None, if_property=None, how=None):
        super(PolicyUpdateRequest, self).__init__()
        self.meta = meta
